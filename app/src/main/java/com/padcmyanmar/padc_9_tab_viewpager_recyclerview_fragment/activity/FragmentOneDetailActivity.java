...
import com.padcmyanmar.padc_9_tab_viewpager_recyclerview_fragment.adapter.FragmentOneViewpagerAdapter;

public class FragmentOneDetailActivity extends AppCompatActivity {

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);

        setContentView(R.layout.fragment_one_activity_detail);

        Toolbar toolbar = findViewById(R.id.tb_fragment_one);
        ...
        FragmentOneViewpagerAdapter adapter = new FragmentOneViewpagerAdapter();
