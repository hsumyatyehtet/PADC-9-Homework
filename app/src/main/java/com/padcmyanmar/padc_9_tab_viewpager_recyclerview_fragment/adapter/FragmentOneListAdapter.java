...
public class FragmentOneListAdapter extends RecyclerView.Adapter {

    private FragmentDelegate mFragmentDelegate;

    public FragmentOneListAdapter(FragmentDelegate mFragmentDelegate) {
        this.mFragmentDelegate = mFragmentDelegate;
    }

    @Override
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View itemView = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.fragment_one_card_view, viewGroup, false);
